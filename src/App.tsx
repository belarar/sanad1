...
import { PrebuiltFichesGalleryModal } from "./components/PrebuiltFichesGalleryModal";
  ...
  return (
    <div className="min-h-screen bg-[#f0f2f5] text-slate-900 flex flex-col font-['Cairo',sans-serif]">
      ...
      <Navbar
        ...
        onOpenGalleryClick={() => setIsGalleryModalOpen(true)}
      ...
      <PrebuiltFichesGalleryModal
        isOpen={isGalleryModalOpen}
        onClose={() => setIsGalleryModalOpen(false)}
        onSelectFiche={(fiche) => {
          setCurrentFiche(fiche);
          setViewMode("viewer");
          handleSaveToArchive(fiche);
        }}
      />
    </div>
  );
