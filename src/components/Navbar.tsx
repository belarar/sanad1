      ...
      <div className="max-w-7xl w-full mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-3 text-sm font-medium">
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-amber-300 hover:text-amber-200 hover:bg-amber-950/40 rounded-lg transition-colors border border-amber-500/30 cursor-pointer"
            title="بنك النماذج التطبيقية المكتملة لجميع المواد"
          >
            <BookOpen className="w-4 h-4 text-amber-400" />
            <span className="font-bold">نماذج جاهزة</span>
          </button>
