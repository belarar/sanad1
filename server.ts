...
احرص بدقة تامة على:
1. تجنب القوالب العامة الفارغة أو الكلام النظري المجرد! يجب أن تحتوي المذكرة على أمثلة حقيقية ملموسة، نصوص، تمارين بأرقامها وحلولها، تجارب علمية بموادها وخطواتها، شواهد لغوية أو آيات قرآنية أو تواريخ وأحداث حسب المادة المعنية.
2. صياغة الكفاءات وفق المصطلحات الرسمية لوزارة التربية الوطنية الجزائرية:
   - الكفاءة الشاملة للطور/المستوى بدقة المنهاج.
   - الكفاءة الختامية الخاصة بالميدان.
   - مركّبات الكفاءة (أفعال إجرائية دقيقة وسلوكية قابلة للقياس).
   - معايير ومؤشرات التقويم ومؤشرات النجاح (الوجاهة، الاستعمال السليم لأدوات المادة، الانسجام).
   - السندات والدعائم الديدكتيكية الفعلية (أرقام صفحات الكتاب المدرسي، وثائق، أنابيب اختبار/كواشف أو خرائط أو مجسمات).
   - القيم والمواقف الوطنية والتربوية المستهدفة (الهوية، العمل الجماعي، الحس البيئي والصحي...).
3. تفصيل مراحل سيرورة الحصة التعليمية التعلمية في جدول زمني واقعي غني بالأمثلة الميدانية:
   أ. وضعية الانطلاق (Mise en situation): التذكير بالمكتسبات القبلية + نص الوضعية المشكلة الانطلاقية الجزئية كاملاً مع سند ملموس وسؤال التحدي.
   ب. مرحلة بناء التعلمات / إرساء الموارد (Construction des apprentissages): التفصيل الدقيق لمهام الأستاذ (الأسئلة الدقيقة المكتوبة، التوجيه الديدكتيكي)، ومهام المتعلم (الأجوبة المنتظرة، الفرضيات المكتوبة، الملاحظة العينية، تحليل الوثائق أو إجراء التجارب)، مع كتابة الأمثلة التطبيقية نصاً.
   ج. مرحلة الاستثمار والتقويم / الإدماج الجزئي (Évaluation & Réinvestissement): تمرين أو مسألة تطبيقية واضحة بنصها الكامل مع حلها النموذجي.
4. الملخص السبوري المهيكل (المورد المعرفي المُرسي والمكتمل الذي ينقله التلميذ على كراسه مع الأمثلة والقواعد الواضحة).
5. النشاط الإدماجي المنزلي (تمرين محدد بنصه وصفحته من الكتاب المدرسي).
6. شبكة التقويم الذاتي والملاحظات للأستاذ مع الصعوبات المتوقعة وطرق علاجها الديدكتيكي.
